...
import { useMutateDeleteNofity, useQueryNotifications } from '../../hooks/notify.hook';
...
export const NotificationsPage = () => {
    ...
    const hasAdmin = userStorage?.roles.some((r) => r == environment.ROLE_ADMIN);
    ...
    const { mutate: mutateDelete, isLoading: isLoadingDelete } = useMutateDeleteNofity();
    ...
    return (
        <>
                        ...
                        <tbody>
                            ...
                            {data?.data.map((notification) => (
                                <tr key={notification._id} className="">
                                    ...
                                    <td>{hasAdmin ? notification.user : notification.user ? 'PRIVADA' : 'PUBLICA'}</td>
            ...
            {deleteId && (
                ...
                >
                    ¿Esta seguro de eliminar la notificación?
                </ConfirmModal>
            )}
        </>
    );
